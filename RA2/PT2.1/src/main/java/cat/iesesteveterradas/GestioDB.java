...
public class GestioDB {
    ...
    public static void popularFaccions(Connection conn) throws SQLException{
        try {
            ...
            UtilsSQLite.queryUpdatePS(conn, "INSERT INTO faccio (nom, resum) VALUES (?, ?)", "Samurai", "The Samurai are the most unified of the five factions, though this does not say much as the Daimyos were often battling each other for dominance. They are the smallest in number and facing almost constant threat of extinction.");
            UtilsSQLite.queryUpdatePS(conn, "INSERT INTO faccio (nom, resum) VALUES (?, ?)", "Wu Lin", "When the Cataclysm hit, China was not prepared for the civil war that would break out. Even when a ruler was established under a prestigious dynasty, kingdoms would fall from unrest and rebellions. As a result of all this conflict and misery, a number of warriors have chosen to venture West, finding themselves in Heathmoore.");
